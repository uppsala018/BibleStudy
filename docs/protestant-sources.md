...
Primary source note used for the current Protestant library build:

- `C:\Users\renem\Downloads\Historical Analysis of Protestantism_ From the Reformation to the Present Day.md`

External resources referenced in the Protestant library:
